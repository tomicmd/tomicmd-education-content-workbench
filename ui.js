            ...
            (error) => {
                ...
                if (error.needConfig) {
                    contentDiv.innerHTML = `
                        <div style="padding: 20px; background: #fff3cd; border: 1px solid #ffc107; border-radius: 8px; margin-bottom: 15px;">
                            <p style="color: #856404; margin: 0 0 10px 0;">
                                <i class="fas fa-exclamation-triangle"></i> 
                                <strong>未配置API Token</strong>
                            </p>
                            <p style="color: #856404; margin: 0 0 15px 0;">
                                需要先配置API Token才能使用AI功能。
                            </p>
                            <button onclick="window.location.href='config.html'" 
                                    style="padding: 10px 20px; background: #ffc107; color: #000; border: none; border-radius: 6px; cursor: pointer; font-weight: 600;">
